...
public class OrderResponse {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clOrdLinkID, simpleOrderQty, ordRejReason, clOrdID, avgPx, pegPriceType, currency, timestamp, displayQty, workingIndicator, contingencyType, side, cumQty, exDestination, transactTime, pegOffsetValue, triggered, execInst, text, settlCurrency, orderID, symbol, multiLegReportingType, timeInForce, ordType, ordStatus, stopPx, price, simpleCumQty, leavesQty, account, simpleLeavesQty, orderQty);
    }
